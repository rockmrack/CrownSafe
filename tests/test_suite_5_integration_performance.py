...
class TestIntegrationAndPerformance:
    ...
    def test_password_reset_flow(self):
        ...
        response1 = client.post("/api/v1/auth/password-reset/request", json={
            "email": "test@test.com"
        })
        assert response1.status_code in [200, 400, 404, 422, 500]
        
        # Step 2: Confirm reset (with invalid token for testing)
        response2 = client.post("/api/v1/auth/password-reset/confirm", json={
            "token": "test-token",
    ...
    def test_barcode_scan_flow(self):
        ...
        # Scan barcode
        response = client.post("/api/v1/barcode/scan", json={
    ...
    def test_error_recovery_flow(self):
        ...
        # Make valid request
        response2 = client.post("/api/v1/feedback", json={
    ...
    def test_e2e_barcode_journey(self):
        ...
        # 1. Scan barcode
        response1 = client.post("/api/v1/barcode/scan", json={
            "barcode": "123456789012"
        })
