...
def test_load_cases():
    ...
    test_data = [
        ...
        {"id": "test2", "scan_data": {"category": "cheese"}, "expect": {"must_flags": ["soft_cheese"]}}
    ]
...
def test_check_case_must_checks():
    ...
    resp = {
        "summary": "Test", "disclaimer": "Test", "reasons": [], 
        "checks": ["Check for pasteurisation on label"], "flags": []
    }
...
def test_check_case_must_flags():
    ...
    resp = {
        "summary": "Test", "disclaimer": "Test", "reasons": [], 
        "checks": [], "flags": ["soft_cheese", "contains_peanuts"]
    }
