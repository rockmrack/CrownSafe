...
from agents.guideline_agent.agent_logic import CAPABILITIES, GuidelineAgentLogic
...
class TestGuidelineAgentLogic:
    ...
    def test_process_message_query_guidelines(self):
        ...
        message_data = {
            "mcp_header": {"message_type": "TASK_ASSIGN", "sender_id": "test_sender"},
            "payload": {
                "task_id": "task_123",
                "workflow_id": "workflow_456",
                "parameters": {"task_type": "query_guidelines", "keywords": ["test"]},
            },
        }
    ...
    def test_process_message_unknown_task(self):
        ...
        message_data = {
            ...
            "payload": {
                "task_id": "task_123",
                "workflow_id": "workflow_456",
                "parameters": {"task_type": "unknown_task"},
            },
        }
    ...
    def test_process_message_pong(self):
        ...
        message_data = {
            "mcp_header": {"message_type": "PONG", "sender_id": "test_sender"},
            "payload": {},
        }
    ...
    def test_process_message_discovery_ack(self):
        ...
        message_data = {
            "mcp_header": {"message_type": "DISCOVERY_ACK", "sender_id": "test_sender"},
            "payload": {},
        }
    ...
    def test_process_message_unknown_message_type(self):
        ...
        message_data = {
            "mcp_header": {"message_type": "UNKNOWN_TYPE", "sender_id": "test_sender"},
            "payload": {},
        }
    ...
    def test_list_available_guidelines(self):
        ...
        # Mock guidelines data
        agent.guidelines_data = {
            "guideline1": {"metadata": {"title": "Guideline 1", "source": "Agency 1"}},
            "guideline2": {"metadata": {"title": "Guideline 2", "source": "Agency 2"}},
        }
    ...
    def test_validate_message_structure_valid(self):
        ...
        message_data = {
            "mcp_header": {"message_type": "TASK_ASSIGN", "sender_id": "test_sender"},
            "payload": {"task_id": "task_123", "parameters": {}},
        }
    ...
    def test_validate_message_structure_missing_header(self):
        ...
        message_data = {"payload": {"task_id": "task_123"}}
    ...
    def test_validate_message_structure_missing_payload(self):
        ...
        message_data = {"mcp_header": {"message_type": "TASK_ASSIGN"}}
    ...
    def test_validate_message_structure_missing_task_id(self):
        ...
        message_data = {
            "mcp_header": {"message_type": "TASK_ASSIGN"},
            "payload": {"parameters": {}},
        }
