...
class TestExplainFeedbackEndpoint:
    ...
    def test_explain_feedback_metrics_not_available(self):
        ...
        with patch("api.routers.analytics.get_db") as mock_get_db, \
            ...
            with patch("api.routers.analytics.inc_explain_feedback", side_effect=ImportError("No metrics")):
                payload = {
                    "scan_id": "no_metrics_scan",
                    "helpful": False
                }
...
class TestExplainFeedbackValidation:
    ...
    def test_helpful_boolean_validation(self):
        ...
        payload = {
            "scan_id": "bool_test",
            "helpful": "true"  # Should be boolean
        }
    ...
    def test_scan_id_empty_string(self):
        ...
        payload = {
            "scan_id": "",  # Empty string should fail min_length=1
            "helpful": True
        }
