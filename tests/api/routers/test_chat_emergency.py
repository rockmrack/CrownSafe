...
class TestEmergencyDetection:
    ...
    def test_emergency_terms_completeness(self):
        ...
        expected_terms = {
            "choking", "stopped breathing", "not breathing", "battery", 
            "ingested", "swallowed", "poison", "seizure", "anaphylaxis", 
            "severe reaction", "unconscious", "allergic reaction",
            "difficulty breathing", "can't breathe", "turning blue", 
            "chemical burn", "overdose"
        }
