...
class TestEmergencyMetrics:
    ...
    def test_inc_unclear_with_prometheus(self, mock_chat_unclear) -> None:
    ...
    @patch("core.metrics.PROM", True)
    @patch("core.metrics.CHAT_UNCLEAR")
    def test_multiple_unclear_calls(self, mock_chat_unclear) -> None:
    ...
    @patch("core.metrics.PROM", True)
    @patch("core.metrics.CHAT_EMERG")
    def test_multiple_emergency_calls(self, mock_chat_emerg) -> None:
    ...
    def test_metrics_counter_names(self) -> None:
    ...
    @patch("core.metrics.PROM", True)
    def test_metrics_are_counters(self) -> None:
    ...
    @patch("core.metrics.PROM", False)
    def test_metrics_are_no_op_when_disabled(self) -> None:
