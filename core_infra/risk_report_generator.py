...
from core_infra.risk_assessment_models import (
    ...
    CompanyComplianceProfile, RiskAssessmentReport
)
...
class RiskReportGenerator:
    ...
    def _prepare_report_data(self,
                            ...
                            risk_components: RiskScoreComponents,
                            incidents: List[SafetyIncident],
                            company_profile: Optional[CompanyComplianceProfile]) -> Dict:
        """
    ...
    def _summarize_incidents(self, incidents: List[SafetyIncident]) -> str:
        ...
        # Recent incidents
        recent = [i for i in incidents if i.incident_date and 
                 (datetime.utcnow() - i.incident_date).days < 90]
        if recent:
    ...
    def _generate_recommendations(self, risk_components: RiskScoreComponents) -> List[str]:
        ...
        if risk_components.risk_level == "critical":
            ...
            recommendations.append(
                "Monitor CPSC.gov for updates on this product"
            )
        ...
        recommendations.append(
            "Report any safety issues to CPSC at SaferProducts.gov"
        )
