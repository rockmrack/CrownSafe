...
class BabyShieldCacheManager:
    ...
    def set(self, cache_type: str, identifier: str, data: Any, custom_ttl: Optional[int] = None, **kwargs) -> bool:
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_keys": sum(db.get("keys", 0) for db in info.get("keyspace", {}).values() if isinstance(db, dict)),
