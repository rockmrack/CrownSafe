...
class Settings(BaseSettings):
    ...
    PORT: int = Field(default=8001, description="Port to bind the service") # Using a different port than the agent server (8003)
    ...
    JWT_SECRET_KEY: str = Field(default="YOUR_SUPER_SECRET_KEY_CHANGE_ME", description="Secret key for JWT encoding/decoding. CHANGE IN PRODUCTION!")
