...
class RiskScoringEngine:
    ...
    def calculate_risk_score(self,
                            ...
                            db: Session) -> RiskScoreComponents:
        """
        ...
        if company_profile:
            components.compliance_score, components.compliance_details = self._calculate_compliance_score(
                company_profile
            )
    ...
    def _calculate_severity_score(self,
                                 product: ProductGoldenRecord,
                                 incidents: List[SafetyIncident]) -> Tuple[float, Dict]:
        """
    ...
    def _calculate_violation_score(self,
                                  product: ProductGoldenRecord,
                                  incidents: List[SafetyIncident],
                                  db: Session) -> Tuple[float, Dict]:
        """
        ...
        high_severity_violations = [
            "choking", "suffocation", "strangulation", "fire", 
    ...
    def _calculate_compliance_score(self,
                                   company_profile: CompanyComplianceProfile) -> Tuple[float, Dict]:
        """
    ...
    def _calculate_confidence(self,
                            product: ProductGoldenRecord,
                            incidents: List[SafetyIncident],
                            company_profile: Optional[CompanyComplianceProfile]) -> float:
        """
        ...
        product_fields = [
            product.gtin, product.upc, product.brand,
    ...
    def calculate_trend(self,
                       historical_scores: List[Tuple[datetime, float]]) -> str:
        """
