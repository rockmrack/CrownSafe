...
def upgrade():
    ...
    op.create_table('account_deletion_audit',
    ...
    op.create_index(op.f('ix_account_deletion_audit_user_id'), 'account_deletion_audit', ['user_id'], unique=False)
    op.create_index(op.f('ix_account_deletion_audit_jti'), 'account_deletion_audit', ['jti'], unique=False)
