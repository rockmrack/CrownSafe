...
def upgrade():
    ...
    op.create_index('idx_product_safety', 'product_ingredients', ['pregnancy_safe', 'baby_safe', 'toddler_safe'])
    op.create_index('idx_product_updated', 'product_ingredients', ['last_updated'])

    # Create ingredient_safety table
    op.create_table('ingredient_safety',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index('idx_ingredient_safety_name', 'ingredient_safety', ['ingredient_name'], unique=True)
    ...
    op.create_index('idx_ingredient_allergen', 'ingredient_safety', ['common_allergen', 'allergen_type'])
