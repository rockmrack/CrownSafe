...
def upgrade():
    ...
    op.create_table('safety_articles',
    ...
    op.create_index(op.f('ix_safety_articles_article_id'), 'safety_articles', ['article_id'], unique=True)
    op.create_index(op.f('ix_safety_articles_id'), 'safety_articles', ['id'], unique=False)
    op.create_index(op.f('ix_safety_articles_is_featured'), 'safety_articles', ['is_featured'], unique=False)
    op.create_index(op.f('ix_safety_articles_source_agency'), 'safety_articles', ['source_agency'], unique=False)
