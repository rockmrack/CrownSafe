...
def upgrade():
    ...
    op.create_index(op.f('ix_scan_history_scan_timestamp'), 'scan_history', ['scan_timestamp'], unique=False)
    ...
    op.create_index(op.f('ix_safety_reports_report_id'), 'safety_reports', ['report_id'], unique=True)
