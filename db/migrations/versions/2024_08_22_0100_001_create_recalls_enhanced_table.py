...
def upgrade() -> None:
    ...
    op.create_index('idx_recalls_enhanced_agency_date', 'recalls_enhanced', ['source_agency', 'recall_date'])
    ...
    try:
        ...
        op.execute(text("CREATE INDEX idx_recalls_enhanced_product_name_trgm ON recalls_enhanced USING gin (product_name gin_trgm_ops)"))
        op.execute(text("CREATE INDEX idx_recalls_enhanced_brand_trgm ON recalls_enhanced USING gin (brand gin_trgm_ops)"))
        op.execute(text("CREATE INDEX idx_recalls_enhanced_model_trgm ON recalls_enhanced USING gin (model_number gin_trgm_ops)"))
