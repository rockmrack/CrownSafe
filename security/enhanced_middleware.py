...
class BulletproofSecurityMiddleware:
    ...
    def _load_attack_patterns(self) -> List[str]:
        ...
        return [
            ...
            # Backup files
            'backup/', 'backups/', 'old/', 'bak/', 'tmp/',
            'dump/', 'sql/', 'db/', 'database/',
            
            # Development paths
            'test/', 'tests/', 'testing/', 'dev/', 'development/',
            'staging/', 'demo/', 'debug/', 'trace/',
            
            # CMS vulnerabilities
            'cms/', 'drupal/', 'wordpress/', 'joomla/',
            'typo3/', 'magento/', 'prestashop/',
            
            # API vulnerabilities
            'api/v1/.git', 'api/config', 'api/admin',
            'graphql', 'graphiql', 'playground',
            
            # Server info disclosure
            'server-info', 'server-status', 'info.php',
            'phpinfo.php', 'test.php', 'index.php~',
    ...
    def _load_suspicious_agents(self) -> List[str]:
        ...
        return [
            ...
            'burpsuite', 'owasp', 'acunetix', 'nessus',
