...
AGENT_CAPABILITIES = [
    {"name": "user_request_handling", "description": "Receives initial user requests and initiates workflows"},
    ...
    {"name": "final_result_reception", "description": "Receives the final status/result of a completed workflow"},
    {"name": "workflow_orchestration", "description": "Orchestrates multi-agent workflows from start to finish"}
]
