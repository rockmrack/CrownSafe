...
class PatientDataAgentLogic:
    ...
    def _load_patient_data(self):
        ...
        try:
            ...
            self.logger.info(
                f"Successfully loaded {len(self.patient_records)} mock patient records from {self.patient_data_path}"
            )
    ...
    def _apply_privacy_filters(
        self, record: Dict[str, Any], requester_id: str, requester_role: str = None
    ) -> Dict[str, Any]:
