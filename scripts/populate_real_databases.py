...
PRODUCT_DATABASE = {
    ...
    "051000013546": {  # Gerber Rice Cereal
        ...
        "brand": "Gerber",
        "category": "baby_food",
        "ingredients": ["rice flour", "vitamin c", "iron", "vitamin e", "niacin", "vitamin b6", "vitamin b1", "folic acid"],
        "allergens": [],
        "pregnancy_safe": True,
        "baby_safe": True,
        "toddler_safe": True,
    ...
    "070074572109": {  # Similac Pro-Advance
        ...
        "ingredients": ["nonfat milk", "lactose", "whey protein concentrate", "high oleic safflower oil", "soy oil", "coconut oil", "galactooligosaccharides"],
        "allergens": ["milk", "soy"],
        "pregnancy_safe": True,
        "baby_safe": True,
        "toddler_safe": False,
    ...
    "038000222015": {  # Gerber Graduates Puffs
        ...
        "ingredients": ["rice flour", "sweet potato puree", "rice bran", "sunflower oil", "vitamin e"],
        "allergens": [],
        "pregnancy_safe": True,
        "baby_safe": True,
        "toddler_safe": True,
    ...
    "381370010654": {  # Johnson's Baby Shampoo
        ...
        "brand": "Johnson's",
        "category": "baby_care",
        "ingredients": ["water", "cocamidopropyl betaine", "sodium trideceth sulfate", "peg-80 sorbitan laurate", "sodium chloride", "fragrance", "citric acid", "sodium benzoate"],
        "allergens": [],
        "pregnancy_safe": True,
        "baby_safe": True,
        "toddler_safe": True,
    ...
    "724120000133": {  # Aveeno Baby Wash
        ...
        "brand": "Aveeno",
        "category": "baby_care", 
        "ingredients": ["water", "cocamidopropyl betaine", "sodium lauroamphoacetate", "glycerin", "coco-glucoside", "avena sativa oat kernel extract"],
        "allergens": [],
        "pregnancy_safe": True,
        "baby_safe": True,
        "toddler_safe": True,
