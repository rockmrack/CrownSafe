...
def test_password_reset():
    ...
    response = client.post("/api/v1/auth/password-reset/validate", 
...
def test_notifications(token: str):
    ...
    # Register device
    response = client.post("/api/v1/notifications/device/register", 
                          headers=headers,
                          json={
    ...
    # Update preferences
    response = client.put("/api/v1/notifications/preferences",
                         headers=headers,
                         json={
...
def test_monitoring(token: str):
    ...
    response = client.post("/api/v1/monitoring/products/add",
                          headers=headers,
                          json={
