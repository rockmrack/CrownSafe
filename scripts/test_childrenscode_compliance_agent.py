...
from agents.governance.childrenscode_compliance_agent.agent_logic import ChildrensCode_ComplianceAgentLogic
...
def test_childrenscode_compliance_logic():
    ...
    for issue in result['issues']:
        print(f"      - Setting '{issue['setting']}' is '{issue['current_value']}', should be '{issue['required_default']}'")
