...
SAMPLE_PRODUCTS = {
    "041220787346": {
        ...
        "brand": "Earth's Best",
        "category": "baby_food",
        "ingredients": ["organic rice flour", "vitamin c", "iron", "thiamine", "riboflavin"],
        "allergens": [],
        "pregnancy_safe": True,
        "baby_safe": True,
        "toddler_safe": True
    ...
    "038000222015": {
        ...
        "ingredients": ["oats", "strawberry puree", "whole wheat flour", "sugar", "soy lecithin"],
        "allergens": ["wheat", "soy"],
        "pregnancy_safe": True,
    ...
    "724120000133": {
        ...
        "brand": "Johnson's",
        "category": "baby_care",
        "ingredients": ["water", "cocamidopropyl betaine", "peg-80 sorbitan laurate", "sodium chloride"],
        "allergens": [],
        "pregnancy_safe": True,
        "baby_safe": True,
        "toddler_safe": True
