...
class SubmissionValidator:
    ...
    def check_metadata_files(self):
        ...
        self.validate_json_file(apple_meta, [
            "appName", "bundleId", "primaryCategory", "sku", 
            "privacyPolicyUrl", "reviewInformation"
        ])
        
        # Google listing
        google_meta = self.base_path / "docs/store/google/listing.json"
        self.validate_json_file(google_meta, [
            "packageName", "title", "shortDescription", 
            "privacyPolicyUrl", "contactEmail"
        ])
    ...
    def check_descriptions(self):
        ...
        self.validate_text_file(long_desc, max_length=4000, required_content=[
            "not medical advice",
            "privacy",
            "FDA",
            "CPSC"
    ...
    def check_review_notes(self):
        ...
        self.validate_text_file(apple_notes, required_content=[
            "Sign in with Apple",
            "Sign in with Google",
            "test",
            "pacifier",
        ...
        self.validate_text_file(google_notes, required_content=[
            "OAuth",
            "test",
            "privacy"
        ])
