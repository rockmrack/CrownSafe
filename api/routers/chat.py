...
EMERGENCY_TERMS = {
    "choking", "choke", "stopped breathing", "not breathing", "battery", 
    "ingested", "swallowed", "poison", "seizure", "anaphylaxis", 
    "severe reaction", "unconscious", "allergic reaction", "difficulty breathing", 
...
# Preparation terms
PREP_TERMS = {
    "prepare", "mix", "make", "heat", "warm", "temperature", "bottle", 
    "formula", "how much", "ratio", "water", "powder", "scoop"
}

# Age-related terms
AGE_TERMS = {
    "age", "old", "month", "year", "newborn", "infant", "toddler", 
    "baby", "suitable", "appropriate", "ready"
}
...
class SuperSmartLLMClient:
    ...
    def _initialize_patterns(self) -> Dict[str, Any]:
        ...
        return {
            "safety_guidelines": {
                ...
                "allergens": {
                    "common": ["milk", "soy", "eggs", "wheat", "peanuts", "tree nuts", "fish", "shellfish"],
                    "signs": ["rash", "hives", "swelling", "vomiting", "diarrhea", "breathing difficulty"]
                }
            },
            "emergency_protocols": {
                "choking": {
    ...
    def _emergency_response(self, query: str) -> Dict[str, Any]:
        ...
        response = {
            ...
            "evidence": [
                {"type": "guideline", "source": "American Academy of Pediatrics", "id": "emergency_care"}
            ],
            "suggested_questions": [],
            "emergency": {
                "level": "critical",
    ...
    def _update_conversation_memory(self, conversation_id: str, query: str, response: Dict[str, Any], context: Dict[str, Any]):
    ...
    def chat_json(self, model: str = "gpt-4", system: str = "", user: str = "", 
                  response_schema=None, timeout: float = 30.0, 
...
def build_suggested_questions(category: str, profile: dict) -> List[str]:
    ...
    questions.extend(category_questions.get(category, ["Is this safe?", "Age appropriate?"]))
