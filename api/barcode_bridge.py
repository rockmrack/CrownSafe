...
def _normalize_scan_payload(barcode: str, payload: dict, trace_id: str, cached: bool) -> dict:
    ...
    data["barcode"] = barcode  # Always use request barcode
...
# ========================= DATABASE SEARCH =========================
# REMOVED FOR CROWN SAFE: All RecallDB search functions gutted
# Crown Safe focuses on hair product testing (HairProductModel), not baby recalls
# Previously implemented:
# - search_exact_barcode: UPC/EAN/GTIN exact matching against RecallDB
# - search_similar_products: Fuzzy matching by brand/category/partial barcode
